 ...
 */
var EntryActionBehaviour = /** @class */ (function () {
    /**
     ...
     */
    function EntryActionBehaviour(_action, _desscription, _trigger) {
        if (_trigger === void 0) { _trigger = null; }
        this._action = _action;
        this._desscription = _desscription;
        this._trigger = _trigger;
    }
    EntryActionBehaviour.prototype.execute = function (transition, args) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        result = this._action.apply(this._action, [transition].concat(args));
    ...
    Object.defineProperty(EntryActionBehaviour.prototype, "trigger", {
        get: function () { return this._trigger; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(EntryActionBehaviour.prototype, "description", {
        get: function () { return this._desscription; },
        enumerable: true,
        configurable: true
    });
    return EntryActionBehaviour;
}());
