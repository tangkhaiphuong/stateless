...
export declare class StateConfiguration<TState, TTrigger> {
     ...
     * @memberof StateConfiguration
     */
    internalTransitionIf(trigger: TTrigger, guard: (((...args: any[]) => boolean | Promise<boolean>)), internalAction: ((transition: Transition<TState, TTrigger>, ...args: any[]) => void)): StateConfiguration<TState, TTrigger>;
    /**
     * Add an internal transition to the state machine. An internal action does not cause the Exit and Entry actions to be triggered, and does not change the state of the state machine
     *
     * @param {TTrigger} trigger
    ...
    } | ((...args: any[]) => boolean | Promise<boolean>)> | ((...args: any[]) => boolean | Promise<boolean>), description?: string | null): StateConfiguration<TState, TTrigger>;
    /**
     ...
     */
    ignore(trigger: TTrigger): StateConfiguration<TState, TTrigger>;
    /**
     ...
     * @memberof StateConfiguration
     */
    onEntry(entryAction: ((transition: Transition<TState, TTrigger>) => any | Promise<any>), entryActionDescription?: string | null): StateConfiguration<TState, TTrigger>;
    /**
     * Specify an action that will execute when transitioning into the configured state.
     *
     ...
     * @memberof StateConfiguration
     */
    onEntryFrom(trigger: TTrigger, entryAction: ((transition: Transition<TState, TTrigger>, ...args: any[]) => any | Promise<any>), entryActionDescription?: string | null): StateConfiguration<TState, TTrigger>;
    /**
