...
class StateRepresentation {
    ...
    canHandle(trigger, ...args) {
        return __awaiter(this, void 0, void 0, function* () {
            const [result] = yield this.tryFindHandler(trigger, args);
            return result;
        });
    }
    ...
    activate() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!!this._superstate) {
                yield this._superstate.activate();
            }
            if (this._active) {
                return;
            }
    ...
    deactivate() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._active = false;
            if (!!this._superstate) {
                yield this._superstate.deactivate();
            }
        });
    }
    tryFindHandler(trigger, ...args) {
        return __awaiter(this, void 0, void 0, function* () {
            const [result, handler] = yield this.tryFindLocalHandler(trigger, args);
            if (result) {
                return [result, handler];
            }
            if (this.superstate !== null) {
                return yield this.superstate.tryFindHandler(trigger, args);
            }
            return [false, undefined];
        });
    }
    tryFindLocalHandler(trigger, args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const item of handler) {
                const condition = yield item.unmetGuardConditions(args);
    ...
    addEntryAction(trigger, action, entryActionDescription = null) {
    ...
    internalAction(transition, args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (aStateRep !== null) {
                const [result] = yield aStateRep.tryFindLocalHandler(transition.trigger, args);
                if (result) {
        ...
        const implement = () => __awaiter(this, void 0, void 0, function* () {
            ...
            for (const item of this._triggerBehaviours) {
                ...
                for (const subItem of item['1']) {
                    if ((yield subItem.unmetGuardConditions(args)).length === 0) {
                        flag = true;
                        break;
                    }
                }
            ...
            if (!!this.superstate) {
                for (const item of yield this.superstate.getPermittedTriggers(args)) {
                    result.push(item);
                }
            }
            return result;
