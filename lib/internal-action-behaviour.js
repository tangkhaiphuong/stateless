 ...
 */
var InternalActionBehaviour = /** @class */ (function () {
    function InternalActionBehaviour(_action) {
        this._action = _action;
    }
    InternalActionBehaviour.prototype.execute = function (transition, args) {
        return __awaiter(this, void 0, void 0, function () {
            var reuslt;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        reuslt = this._action(transition, args);
    ...
    return InternalActionBehaviour;
}());
