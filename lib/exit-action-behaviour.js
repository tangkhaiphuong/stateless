 ...
 */
var ExitActionBehaviour = /** @class */ (function () {
    /**
     ...
     */
    function ExitActionBehaviour(_action, _description) {
        this._action = _action;
        this._description = _description;
    }
    ExitActionBehaviour.prototype.execute = function (transition) {
        return __awaiter(this, void 0, void 0, function () {
            var reuslt;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        reuslt = this._action(transition);
                        if (!(reuslt instanceof Promise)) return [3 /*break*/, 2];
                        return [4 /*yield*/, reuslt];
                    case 1:
                        _a.sent();
                        _a.label = 2;
    ...
    Object.defineProperty(ExitActionBehaviour.prototype, "description", {
        get: function () { return this._description; },
        enumerable: true,
        configurable: true
    });
    return ExitActionBehaviour;
}());
