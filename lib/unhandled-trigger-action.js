 ...
 */
var UnhandledTriggerAction = /** @class */ (function () {
    function UnhandledTriggerAction(_action) {
        this._action = _action;
    }
    UnhandledTriggerAction.prototype.execute = function (state, trigger, unmetGuards) {
        return __awaiter(this, void 0, void 0, function () {
            var reuslt;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        reuslt = this._action(state, trigger, unmetGuards);
