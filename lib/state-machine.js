...
var StateMachine = /** @class */ (function () {
     ...
     * @memberof StateMachine
     */
    StateMachine.prototype.internalFire = function (trigger) {
        var args = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args[_i - 1] = arguments[_i];
        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.internalFireOne.apply(this, __spread([queuedEvent.trigger], queuedEvent.args))];
                    case 4:
                        _a.sent();
                        return [3 /*break*/, 6];
    ...
    StateMachine.prototype.internalFireOne = function (trigger) {
        var args = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args[_i - 1] = arguments[_i];
        }
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, representativeState.tryFindHandler(trigger)];
                    case 1:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1: return [2 /*return*/, _a + __spread.apply(void 0, [_b.sent()]).join(', ') + " }}"];
                }
            });
        });
    };
