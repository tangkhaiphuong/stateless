...
var StateConfiguration = /** @class */ (function () {
    ...
    StateConfiguration.prototype.ignore = function (trigger) {
        this._representation.addTriggerBehaviour(new ignored_trigger_behaviour_1.IgnoredTriggerBehaviour(this.state, trigger));
        return this;
    };
    /**
    ...
    StateConfiguration.prototype.ignoreIf = function (trigger, state, guards, description) {
        if (description === void 0) { description = null; }
        if (guards instanceof Array) {
            this._representation.addTriggerBehaviour(new ignored_trigger_behaviour_1.IgnoredTriggerBehaviour(state, trigger, new (transition_guard_1.TransitionGuard.bind.apply(transition_guard_1.TransitionGuard, __spread([void 0], guards)))()));
        }
        else {
            this._representation.addTriggerBehaviour(new ignored_trigger_behaviour_1.IgnoredTriggerBehaviour(state, trigger, new transition_guard_1.TransitionGuard({ guard: guards, description: description })));
        }
        return this;
    };
    /**
    ...
    StateConfiguration.prototype.onEntry = function (entryAction, entryActionDescription) {
        ...
        this._representation.addEntryAction(null, entryAction, invocation_info_1.InvocationInfo.create(entryAction, entryActionDescription));
        return this;
    };
    /**
     * Specify an action that will execute when transitioning into the configured state.
    ...
    StateConfiguration.prototype.permitDynamic = function (trigger, destinationStateSelector, destinationStateSelectorDescription, possibleDestinationStates) {
        ...
        this._representation.addTriggerBehaviour(new dynamic_trigger_behaviour_1.DynamicTriggerBehaviour(trigger, destinationStateSelector, null, // No transition guard
