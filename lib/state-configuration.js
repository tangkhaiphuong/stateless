...
class StateConfiguration {
     ...
     * @memberof StateConfiguration
     */
    permitIf(trigger, destinationState, guards, description = null) {
        this.enforceNotIdentityTransition(destinationState);
     ...
     * @memberof StateConfiguration
     */
    permitReentryIf(trigger, guards, description = null) {
        if (guards instanceof Array) {
     ...
     * @memberof StateConfiguration
     */
    ignoreIf(trigger, state, guards, description = null) {
        if (guards instanceof Array) {
     ...
     * @memberof StateConfiguration
     */
    onEntry(entryAction, entryActionDescription = null) {
     ...
     * @memberof StateConfiguration
     */
    onEntryFrom(trigger, entryAction, entryActionDescription = null) {
     ...
     * @memberof StateConfiguration
     */
    permitDynamicIf(trigger, destinationStateSelector, guards, description = null) {
        if (guards instanceof Array) {
